...
export default function spotify({
  ...
  return (
    ...
    >
      <PageSEO
        title={`Lam's Spotify - ${siteMetadata.author}`}
                ...
                <div className="flex items-center gap-2 mt-3 md:mt-0">
                  ...
                  {currentTrack.shuffle_state && (
                    <span title="Play on shuffle">
                      <svg className="w-5 h-5" viewBox="0 0 512 512" fill="black">
  ...
  if (currentTrackFeatures)
    return (
      <div className="flex flex-wrap items-center justify-between gap-2 mt-3">
        <span
          title="valence"
          className={`flex items-center justify-center gap-1 px-4 py-1 bg-black text-semibold text-${
